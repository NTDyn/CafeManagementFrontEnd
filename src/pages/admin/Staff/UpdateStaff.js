...
export default function UpdateStaff({ staff, buttonLabel, dataStaffGroup, staffData }) {
    ...
    //                     <Button
    //                         sx={{
    //                             width: '80px', bgcolor: customer.isActive ? '#23a736' : '#d32f2f', // Xanh nếu active, đỏ nếu inactive
    //                             color: '#fff', // Chữ trắng
    //                             '&:hover': {
    //                                 bgcolor: customer.isActive ? '#1e8e3e' : '#c62828' // Hover đậm hơn
    //                             }
    //                         }}
