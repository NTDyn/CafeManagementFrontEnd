...
//
export const HandleDeny = (form) => {
    return axios.put(API_URL_BASE_SUPPLIER + "/Receipt/handleDeny", form);
}

//
export const showListReceiptAdmin = () => {
    return axios.get(API_URL_BASE_SUPPLIER + "/Receipt/showReceiptInAdmin");
}